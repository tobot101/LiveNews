...
expect(cityDirectoryPage.html.includes("search any U.S. city"), "/local/cities should explain that search covers any U.S. city.");
expect(cityDirectoryPage.html.includes("Top U.S. cities"), "/local/cities should render top cities.");
expect(cityDirectoryPage.html.includes("Houston") && cityDirectoryPage.html.includes("Chicago"), "/local/cities should restore more top U.S. city options.");
expect(cityDirectoryPage.html.includes('id="localCityDirectorySearch"'), "/local/cities should include a city search input.");
expect(cityDirectoryPage.html.includes("/api/places?q="), "/local/cities search should use the full U.S. city index.");
...
expect(cityDirectoryPage.html.includes("/local/texas/houston"), "/local/cities should link top cities to crawlable city URLs.");
