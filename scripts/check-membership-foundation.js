...
expect(!authUi.includes("emailVerified: Boolean(user.emailVerified)"), "Frontend should not write emailVerified to users/{uid}; verification status should come from Firebase Auth.");
...
expect(accountHtml.includes("accountVerifiedBanner") && accountHtml.includes("Your email is verified."), "Account page should show a verified success banner for /account?verified=1.");
expect(accountHtml.includes("Continue to Live News"), "Account page should include a Continue to Live News button.");
