...
function buildInstagramCardPlan(context = {}) {
  ...
  const renderedGeneratedCardUrl = isDurablePublicImageUrl(context.generatedCardUrl) ? cleanText(context.generatedCardUrl) : "";
  const plannedGeneratedCardUrl = renderedGeneratedCardUrl || buildGeneratedCardUrl(context);
  const durableImageUrl = approvedStoryImageUrl || pickDurableImageUrl(context) || renderedGeneratedCardUrl;
  ...
  return {
    ...
    imageUrl: approvedStoryImageUrl || "",
    generatedCardUrl: renderedGeneratedCardUrl,
    plannedGeneratedCardUrl,
