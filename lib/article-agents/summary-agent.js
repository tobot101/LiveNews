...
function stripHeadlinePrefix(value) {
  return cleanText(value)
    .replace(/^(watch|video|listen|live updates?|update|the latest|latest|breaking|photos?|tst images|michael smolens):\s*/i, "")
...
function buildLocalContextSentences(item) {
  ...
  return [
    "The note stays brief because the feed provides limited extra detail.",
