...
const { buildStoryWritingPackage } = require("./writing-quality");
...
function validateDraftForApproval(draft) {
  ...
  const writingPackage = draft ? buildStoryWritingPackage(draft) : null;
...
function toApprovedStory(draft, options = {}) {
  ...
  const writingPackage = buildStoryWritingPackage(draft);
