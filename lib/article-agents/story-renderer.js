...
<html lang="en" data-theme="day">
  ...
  <body class="story-body-page">
    <header class="topbar story-topbar">
      ...
      <a class="btn ghost back-home-link" href="/">Back to Live News</a>
    </header>
    <main class="story-page">
      <article class="story-shell">
        ...
        <section class="story-section">
          ...
          <p>${escapeHtml(story.whyItMatters || "Live News is tracking this story because it is part of active recent coverage.")}</p>
        </section>
  ...
  <body>
    ...
    <main class="story-page">
      <section class="story-shell">
        ...
        <a class="story-action" href="/">Back to Live News</a>
      </section>
    </main>
  </body>
</html>`;
