...
const STORE_PATHS = {
  ...
  socialDrafts: path.join(DATA_DIR, "social-drafts.json"),
  socialVariantSelections: path.join(DATA_DIR, "social-variant-selections.json"),
  socialStyleMemory: path.join(DATA_DIR, "social-style-memory.json"),
  socialPerformance: path.join(DATA_DIR, "social-performance-memory.json"),
  trendSignalMemory: path.join(DATA_DIR, "trend-signal-memory.json"),
  summaryReviewDecisions: path.join(DATA_DIR, "summary-review-decisions.json"),
  writingQualityMemory: path.join(DATA_DIR, "writing-quality-memory.json"),
  rewriteQualityMemory: path.join(DATA_DIR, "rewrite-quality-memory.json"),
  metaPosts: path.join(DATA_DIR, "meta-posts.json"),
  approvedStories: path.join(DATA_DIR, "approved-stories.json"),
  audiencePatterns: path.join(DATA_DIR, "audience-patterns.json"),
