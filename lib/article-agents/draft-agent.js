...
function generateDraft(packet, options = {}) {
  ...
  draft.description = writingPackage.description || draft.description;
  draft.metaTitle = writingPackage.metaTitle || `${draft.headline} | Live News`;
  draft.metaDescription = writingPackage.metaDescription || draft.description;
  draft.writingExam = writingPackage.writingExam;
  draft.teacherChecks = writingPackage.teacherChecks;
  draft.writingQualityStatus = writingPackage.writingQualityStatus;
  draft.missingContext = writingPackage.missingContext;
  draft.writingMemoryLessonsUsed = writingPackage.writingMemoryLessonsUsed;
  draft.writingQuality = writingPackage;
