...
function blockingWarnings(variant, platform) {
  ...
  if (platform === "instagram" && !cleanText(variant.imagePlan?.imageUrl || variant.imagePlan?.generatedCardUrl)) {
    warnings.push("Instagram image or generated card is not ready.");
  }
  return warnings;
}
